...
사람들이 저희를 신뢰합니다
          ...
          >
한국모래상자치료학회는 전 세계 수천 명의 전문가들이 신뢰하는 학회입니다. 커뮤니티의 일원이 되어 함께하세요.
          </p>
        </div>
...
이메일 주소
                  ...
                  <div className="mt-2">
                    <input
                      id="email"
                      type="email"
placeholder="therapy@example.com"
                      className="block w-full bg-white dark:bg-neutral-900 px-4 rounded-md border-0 py-1.5  shadow-input text-black placeholder:text-gray-400 focus:ring-2 focus:ring-neutral-400 focus:outline-none sm:text-sm sm:leading-6 dark:text-white"
                    />
                  </div>
                </div>
  ...
  return (
    ...
    >
      <Image
        ...
        height={30}
      />
      <span className="font-medium text-black dark:text-white">한국모래상자치료학회</span>
    </Link>
  );
};
